...
public static class HostLayerExtension
{
  public static IHostApplicationBuilder AddHostLayer(this IHostApplicationBuilder builder)
  {
    ...
    {
      // Windows: default DiskDrives=["/"] không tồn tại; binder không clear list rỗng từ appsettings
      options.System.DiskDrives.Clear();
      options.System.VirtualMemorySizeMegabytesMaximum = 0;
    });
